...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 10 15:53:02 2023
...
co2_df = pd.read_csv(
    ...
    header = 57, # Data starts here
    skiprows = [58, 59], # Headers consist of multiple rows
...
bokeh.plotting.output_file(filename = './GP_Ex.html')
...
bokeh.plotting.output_file(filename = './GP_Ex2.html')
bokeh.plotting.save(fig)
#
...
df_html = HTML(df_variables.to_html(
    index=False, float_format=lambda x: f'{x:.4f}'))

with open ('Gp_Ex3.html', 'w') as f:
...
fig.legend.location = 'top_left'
fig.toolbar.autohide = True
bokeh.plotting.output_file(filename = './GP_Ex4.html')
bokeh.plotting.save(fig)
#